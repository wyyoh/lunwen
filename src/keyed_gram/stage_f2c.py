...
_SOURCE_PATHS = (
    ...
    "docs/f2c/TEMPLATE_ISOLATION_PROTOCOL.md",
    "docs/f2c/BOUNDED_LOOP_SEMANTICS.md",
    ...
    "src/keyed_gram/authsynth_symbolic_verifier/template_families.py",
    "src/keyed_gram/authsynth_symbolic_verifier/template_isolation.py",
    "src/keyed_gram/authsynth_symbolic_verifier/bounded_loop.py",
    "src/keyed_gram/authsynth_symbolic_verifier/symbolic_loop.py",
    "scripts/audit_f2c_templates.py",
    "tests/test_f2c_template_isolation.py",
    "tests/test_f2c_loop_equivalence.py",
